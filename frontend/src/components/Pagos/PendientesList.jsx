...
const PendientesList = () => {
    ...
    return (
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden flex flex-col h-full">
            {/* Header & Controls */}
            <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex flex-col gap-4">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Gestiona los saldos pendientes y recupera clientes inactivos.</p>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full md:w-64 transition-all outline-none"
                            />
                        </div>
                    </div>
                </div>
                ...
                {/* Tabs */}
                <div className="flex space-x-1 p-1 bg-gray-200/50 rounded-lg max-w-md border border-gray-200 dark:border-gray-700 dark:border-gray-700">
                    <button
                        ...
                        className={`flex-1 flex items-center justify-center py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === 'deudores'
                            ...
                            : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:text-white hover:bg-white dark:bg-gray-800 dark:bg-gray-800'
                            }`}
                    >
            ...
            {/* List */}
            <div className="flex-1 overflow-y-auto p-4 lg:p-6 bg-gray-50 dark:bg-gray-900 dark:bg-gray-900/30 custom-scrollbar">
                ...
                {isLoading ? (
                    ...
                    filteredPendientes.length === 0 ? (
                        <div className="flex flex-col items-center justify-center p-12 text-center text-gray-500">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white dark:text-white">No hay pagos pendientes</h3>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredPendientes.map((p) => (
                                <div key={p.asignacion_id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-blue-300 transition-all flex flex-col p-5">
                                    <div className="flex justify-between items-start mb-3">
                                        <div>
                                            <h3 className="font-semibold text-gray-900 dark:text-white truncate max-w-[180px]" title={`${p.cliente_nombre} ${p.cliente_apellido}`}>
                                    ...
                                    <div className="space-y-2 mb-4 text-sm flex-1">
                                        <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-700 pb-1.5">
                                            ...
                                            <span className="text-gray-900 dark:text-white font-medium">{formatCurrency(p.total)}</span>
                                        </div>
                                        <div className="flex justify-between items-center border-b border-gray-100 dark:border-gray-700 pb-1.5">
                                            <span className="text-gray-500">Abonado hasta ahora:</span>
                                            <span className="text-gray-900 dark:text-white font-medium">{formatCurrency(p.abonado)}</span>
                                        </div>
                                    ...
                                    {p.cuotas && p.cuotas.length > 0 ? (
                                        <div className="mt-3 space-y-2">
                                            ...
                                            <div className="max-h-[180px] overflow-y-auto pr-1 space-y-2 custom-scrollbar">
                                                {p.cuotas.map(cuota => (
                                                    <div key={cuota.cuota_id} className="flex flex-col gap-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 dark:border-gray-700">
                                                        <div className="flex justify-between items-center text-sm">
                                                            <span className="text-gray-800 dark:text-gray-200 font-semibold">Cuota {cuota.numero_cuota}</span>
                                        ...
                                        >
                                            <div className="absolute inset-0 w-full h-full bg-white dark:bg-gray-800 dark:bg-gray-800/20 scale-x-0 group-hover:scale-x-100 transform origin-left transition-transform duration-300 ease-out"></div>
                    ...
                    filteredInactivos.length === 0 ? (
                        <div className="flex flex-col items-center justify-center p-12 text-center text-gray-500">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 dark:text-white dark:text-white">No hay clientes inactivos</h3>
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 max-w-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {filteredInactivos.map((i) => (
                                <div key={i.cliente_id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-rose-300 shadow-sm transition-all flex flex-col p-5 relative overflow-hidden group hover:shadow-md">
                                    ...
                                    <div className="flex justify-between items-start mb-3 relative z-10">
                                        <div>
                                            <h3 className="font-semibold text-gray-900 dark:text-white truncate max-w-[200px]" title={`${i.cliente_nombre} ${i.cliente_apellido}`}>
                                                {i.cliente_nombre} {i.cliente_apellido}
                                            </h3>
                                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 font-medium mt-1 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded inline-flex">
                                                <FileText className="w-3 h-3 mr-1" />
                                    ...
                                    <div className="space-y-2 mb-6 text-sm text-gray-600 dark:text-gray-400 flex-1 relative z-10">
                                    ...
                                    <div className="mt-auto flex flex-col gap-2 relative z-10">
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-2 rounded-lg font-medium transition-all flex items-center justify-center 
                                                ${!i.email
                                                    ? 'bg-gray-100 dark:bg-gray-700 text-gray-400 cursor-not-allowed border border-gray-200 dark:border-gray-700 dark:border-gray-700'
                                                    : 'bg-white dark:bg-gray-800 border border-rose-200 text-rose-600 hover:bg-rose-50 hover:border-rose-300 shadow-sm'
                                                }`}
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-gray-900/60 backdrop-blur-sm">
                        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-2xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                            <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex justify-between items-center">
                                ...
                                <button onClick={() => { setSelectedClient(null); setSelectedCuota(null); }} className="text-gray-400 hover:text-gray-600 dark:text-gray-400 hover:bg-gray-200 rounded-full p-1 transition-colors">
                                    <X className="w-5 h-5" />
                                </button>
                            </div>
                            ...
                            <form onSubmit={submitPago} className="p-6">
                                <div className="bg-gray-50 dark:bg-gray-900 p-4 rounded-xl border border-gray-200 dark:border-gray-700 mb-6">
                                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-1">Cliente</div>
                                    <div className="font-semibold text-gray-900 dark:text-white text-lg">{selectedClient.cliente_nombre} {selectedClient.cliente_apellido}</div>
                                    <div className="text-xs text-blue-600 font-medium mt-0.5">{selectedClient.plan_nombre}</div>

                                    <div className="mt-4 flex justify-between items-end border-t border-gray-200 dark:border-gray-700 pt-3">
                                ...
                                <div className="space-y-5">
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Monto a abonar</label>
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className={`w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg pl-10 px-4 py-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition-all ${selectedCuota ? 'bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400 cursor-not-allowed' : ''}`}
                                            />
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition-all"
                                        >
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows="2"
                                            className="w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none"
                                        ></textarea>
                                    </div>
                                </div>
                                ...
                                <div className="mt-8 flex gap-3">
                                    <button
                                        ...
                                        className="flex-1 px-4 py-2.5 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 rounded-xl font-medium transition-colors min-w-[120px]"
                                    >
                                        Cancelar
                                    </button>
                                    <button
